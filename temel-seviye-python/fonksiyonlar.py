...
# Adı: print
# Tanımlarken ve kullanırken parantez işaretleri kullanılır: print("a+b=", a+b)
...
# print("Eren", "Mustafa", "Özdal", sep="-", end="...")
# print("Bot Yazma")

# dosya = open("log.txt", mode="w")
# print("Eren", file=dosya)
...
def islem(sayi1, sayi2, islem_tipi="+"):
    if islem_tipi == "+":
        return sayi1 + sayi2
...
toplama = islem(5, 6)
cikarma = islem(5, 6, islem_tipi="-")
carpma = islem(5, 6, islem_tipi="*")
print(toplama, cikarma, carpma)
